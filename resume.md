...
* Proposed and led migration of Tableau Exchange to Next.js leading to a 50% increase on monthly active users due to improved crawlability.
...
*	Implemented screen reader support for Kindle Fire and Fire Phone bookstore.
